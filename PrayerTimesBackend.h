...
class PrayerTimesBackend : public QObject {
    ...
    Q_PROPERTY(QString latitude READ latitude NOTIFY coordinatesChanged)
    Q_PROPERTY(QString longitude READ longitude NOTIFY coordinatesChanged)
    Q_PROPERTY(QString qiblaDirection READ qiblaDirection NOTIFY coordinatesChanged)
...
public:
    ...
    QString qiblaDirection() const { return m_qiblaDirection; }
